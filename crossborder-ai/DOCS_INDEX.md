...
| **README.md** | 项目门面（中文为主）：定位、能力地图、技术栈、快速开始、架构约束、部署与文档索引 | 对外展示 / 新人上手 |
...
| **DEPLOYMENT_COMPLETE.md** | 上线备忘：访问地址与后续事项 | 看线上状态与待办 |
...
| **INTERVIEW_QA_SCRIPT.md** | 面试逐字稿：前端岗一问一答（25 问，口语化） | ⭐ 面试前 |
| **RESUME.md** | 简历内容（AI 全栈岗）：标题字数安全版、主版本、精简版、面试准备表。**仅存本机，未入库**（已加入 .gitignore，本地备份见 `backups/RESUME.md.bak`） | ⭐ 投简历前 |
...
| 文件 | 作用 | 什么时候看 |
|------|------|-----------|
| **specs/** | ⭐ SDD 行为规格（能力点 + 需求场景）：`scrape-1688`、`onboarding-retention` | 开发对应模块前 |
| **docs/product/诊断报告与商业优化方案-2026-09-03.md** | 全盘产品诊断：主题、功能、AI 画像的短板与改进方案，含 CAP-01…10 立项清单 | 定优先级 / 做规划 |
| **docs/production-readiness.md** | 生产就绪度评估 | 上线前 |
| **docs/收口-2026-09-08.md** | CAP-01~07 批次收口记录、三类根因修复与回归门禁 | 追溯 2026-09 的修复范围 |

> 完事请顺手把新文档登记到本文件，别让导航继续过期。
